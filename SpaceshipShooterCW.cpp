...
void drawAsteroidShape(GLfloat xCentre, GLfloat yCentre, GLfloat radius, int type)
{
	//get the pattern angle of the polygon ex. 360/6 = 60degrees meaning is a hexagon
	...
	{
		//get direction of each point of the polygon
		dx = sin(StartAngle * PI / 180);
		dy = cos(StartAngle * PI / 180);
		//get coordinates of the points and draw them
		glVertex2f(xCentre + dx * radius, yCentre + dy * radius);
		//increase the angle to be able to draw the other point 
